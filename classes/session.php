...
class SessionManager {
    ...
    // Expire sessions after ten minutes in inactivity
    const SESSION_TIMEOUT = 600;
    // Expire session after one hour
    ...
    public function __construct() {
        $this->_mongo = DBConnection::singleton();
        ...
        session_set_cookie_params(
                SessionManager::SESSION_LIFESPAN, SessionManager::SESSION_COOKIE_PATH, SessionManager::SESSION_COOKIE_DOMAIN
        );
